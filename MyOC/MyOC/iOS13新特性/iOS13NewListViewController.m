...
#import "iOS13NewListViewController.h"

@interface iOS13NewListViewController ()
@property(nonatomic,strong)NSMutableArray *titles;
@end

@implementation iOS13NewListViewController
...
- (void)viewDidLoad {
    ...
    [self.titles addObject:@{@"Dark Mode 黑暗模式"
                            :@"DarkModeViewController"}];
    
    [self.titles addObject:@{@"PDF 长图"
                            :@"PDFLongPicViewController"}];
